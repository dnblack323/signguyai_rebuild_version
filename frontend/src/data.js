...
export const modules = {
  ...
  tools: [
    ["assistant", "Assistant", Bot, "planned"],
    ["ai-suite", "AI Suite", WandSparkles, "planned"],
...
export const moduleDetails = {
  ...
  notes: { title: "Notes", description: "Shared shop notes and operational notes.", metric: "Notes ready", action: "New note" },
  ...
  assistant: { title: "Assistant", description: "Business assistant for shop questions, summaries, and guidance.", metric: "Assistant planned", action: "Ask assistant" },
  "ai-suite": { title: "AI Suite", description: "AI tools for content, design, estimates, and workflow support.", metric: "AI suite planned", action: "Open AI suite" },
  ...
  community: { title: "Community", description: "Community resources and shared learning.", metric: "Community planned", action: "Open community" },
